...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('pirates').insert({id: default, name: 'Le\' Chuck', poison: 'Voodoo Goo Grog', accessory: 'Push Pins', image_url: 'https://pbs.twimg.com/profile_images/1866704249/monkey-island-don-t-fuck-with-lechuck_design_400x400.png'}),
